    ...
    <div className="cookieModalMain">
      <div className="modalContainer">
        <div className="cookies-customization-content">
          ...
          adres:
          <span>[adres siedziby/zamieszkania]</span>, KRS:
          <span>[numer]</span>, NIP:
          <span>[numer]</span>, REGON:
          ...
          <ol>
            <li>
              Dane Użytkowników nie mogą być przetwarzane w zautomatyzowany
              sposób tak, że na skutek tego mogłyby zapaść wobec nich
