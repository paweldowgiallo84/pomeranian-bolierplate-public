...
const techstackIons = [
  ...
  {
    icon: (
      <img className="svg__normal__size" src={bigBucketIcon} alt="Bigbucket" />
    ),
  ...
  {
    icon: <img className="svg__normal__size" src={discordIcon} alt="Discord" />,
  ...
  {
    icon: <img className="svg__normal__size" src={redmineIcon} alt="Redmine" />,
    techstachTitle: 'Redmine',
  },
];

export default techstackIons;
